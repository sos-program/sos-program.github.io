...
(i.e. not extirpated), and are either part of the original CU list developed by <a href="https://waves-vagues.dfo-mpo.gc.ca/library-bibliotheque/334860.pdf">Holtby and Ciruna (2007)</a>, or have been
 modified and approved by a CU expert team. The CU expert team ensure methodological processes align with details presented in <a href="https://waves-vagues.dfo-mpo.gc.ca/library-bibliotheque/334860.pdf">Holtby and Ciruna (2007)</a>. CU revisions are submitted to the <a href="Bruce.Baxter@dfo-mpo.gc.ca"> Data Management Unit in Pacific Science</a>. Revisions to the original CU list have been completed for Fraser sockeye and Southern BC Chinook ([Grant et al. 2011, Brown et al. 2019](./References.md)). One other classification of CU is 'validation required' and these are not considered CUs, but are placeholders pending new genetic, ecological and biological knowledge.
