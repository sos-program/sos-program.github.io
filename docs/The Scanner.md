...
We use version control for both the Scanner, and separately the data included. We recommend citing DFO's Salmon Scanner and the Scanner and Data version you are using when presenting information from the Scanner in presentations or publications, for transparency and repeatability aspects of the scientific process.
Current versions:
**Scanner: 1.3.1**
**Data: 0.4.1**
